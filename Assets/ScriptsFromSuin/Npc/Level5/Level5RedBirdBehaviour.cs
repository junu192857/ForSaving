...
public class Level5RedBirdBehaviour : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            Level5Counter.birdcount++;
            Level5Counter.redbirdcount++;
            Debug.Log($"Counter added. current count:{Level5Counter.birdcount}");
            Debug.Log($"Red Counter added. current count:{Level5Counter.redbirdcount}");
        }
        else if (previousInZoom == true && currentlyInZoom == false)
        {
            Level5Counter.birdcount--;
            Level5Counter.redbirdcount--;
            Debug.Log($"Counter substracted. current count:{Level5Counter.birdcount}");
            Debug.Log($"Red Counter substracted. current count:{Level5Counter.redbirdcount}");
        }
    }
