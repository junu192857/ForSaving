...
public class Level3NPCSpawner : MonoBehaviour
{
    ...
    private float _spawnPeriod = 2.0f; //various depending on level
    ...
    private IEnumerator SpawnRedBird()
    {
        ...
        {   
            ...
            npc.GetComponent<Level3RedBirdBehaviour>().SetDestination(spawnpoint);
    ...
    private IEnumerator SpawnPinkBird()
    {
        ...
        while (true)
        {
            ...
            npc.GetComponent<Level3PinkBirdBehaviour>().SetDestination(spawnpoint);
            npc.transform.SetParent(gameObject.transform);
        yield return new WaitForSeconds(_spawnPeriod);
        }
    }
    ...
    private IEnumerator SpawnBlueBird()
    {
        ...
        while (true)
        {
            ...
            npc.GetComponent<Level3BlueBirdBehaviour>().SetDestination(spawnpoint);
            npc.transform.SetParent(gameObject.transform);
        yield return new WaitForSeconds(_spawnPeriod); 
        }
    }
