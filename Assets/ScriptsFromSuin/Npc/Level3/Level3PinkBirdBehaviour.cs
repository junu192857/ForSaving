...
public class Level3PinkBirdBehaviour : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            Level3Counter.birdcount++;
            Debug.Log($"Counter added. current count:{Level3Counter.birdcount}");
        }
        else if (previousInZoom == true && currentlyInZoom == false)
        {
            Level3Counter.birdcount--;
            Debug.Log($"Counter substracted. current count:{Level3Counter.birdcount}");
        }
    }
