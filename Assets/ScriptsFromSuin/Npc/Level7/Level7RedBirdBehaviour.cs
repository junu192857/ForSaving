...
public class Level7RedBirdBehaviour : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            Level7Counter.birdcount++;
            Level7Counter.redbirdcount++;
            Debug.Log($"Counter added. current count:{Level7Counter.birdcount}");
            Debug.Log($"Red Counter added. current count:{Level7Counter.redbirdcount}");
        }
        else if (previousInZoom == true && currentlyInZoom == false)
        {
            Level7Counter.birdcount--;
            Level7Counter.redbirdcount--;
            Debug.Log($"Counter substracted. current count:{Level7Counter.birdcount}");
            Debug.Log($"Red Counter substracted. current count:{Level7Counter.redbirdcount}");
        }
    }
