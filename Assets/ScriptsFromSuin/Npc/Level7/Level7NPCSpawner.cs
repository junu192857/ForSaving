...
public class Level7NPCSpawner : MonoBehaviour
{
    ...
    private float _spawnPeriod = 1.5f; //various depending on level
    ...
    private IEnumerator SpawnRedBird()
    {
        ...
        {   
            ...
            npc.GetComponent<Level7RedBirdBehaviour>().SetDestination(spawnpoint);
    ...
    private IEnumerator SpawnPinkBird()
    {
        ...
        while (true)
        {
            ...
            npc.GetComponent<Level7PinkBirdBehaviour>().SetDestination(spawnpoint);
            npc.transform.SetParent(gameObject.transform);
        yield return new WaitForSeconds(_spawnPeriod);
        }
    }
    ...
    private IEnumerator SpawnBlueBird()
    {
        ...
        while (true)
        {
            ...
            npc.GetComponent<Level7BlueBirdBehaviour>().SetDestination(spawnpoint);
            npc.transform.SetParent(gameObject.transform);
        yield return new WaitForSeconds(_spawnPeriod); 
        }
    }
