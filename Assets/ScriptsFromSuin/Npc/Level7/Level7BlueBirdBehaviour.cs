...
public class Level7BlueBirdBehaviour : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            Level7Counter.birdcount++; //various
            Debug.Log($"Counter added. current count:{Level7Counter.birdcount}"); //various
        }
        else if (previousInZoom == true && currentlyInZoom == false)
        {
            Level7Counter.birdcount--; //various
            Debug.Log($"Counter substracted. current count:{Level7Counter.birdcount}"); //various
        }
    }
