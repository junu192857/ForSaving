...
public class Level2NPCSpawner : MonoBehaviour
{
    ...
    private IEnumerator SpawnRedBird()
    {
        ...
        {   
            ...
            npc.GetComponent<Level2RedBirdBehaviour>().SetDestination(spawnpoint);
    ...
    private IEnumerator SpawnPinkBird()
    {
        ...
        while (true)
        {
            ...
            npc.GetComponent<Level2PinkBirdBehaviour>().SetDestination(spawnpoint);
            npc.transform.SetParent(gameObject.transform);
        yield return new WaitForSeconds(_spawnPeriod);
        }
    }
    ...
    private IEnumerator SpawnBlueBird()
    {
        ...
        while (true)
        {
            ...
            npc.GetComponent<Level2BlueBirdBehaviour>().SetDestination(spawnpoint);
            npc.transform.SetParent(gameObject.transform);
        yield return new WaitForSeconds(_spawnPeriod); 
        }
    }
